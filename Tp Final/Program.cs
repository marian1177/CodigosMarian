...
namespace Tp_Final
{
    class Program
    {
         ...
         * Partiendo de la estructura de una Queue("Cola") se adhieren instrucciones using como como el : "System.Globalization" y el "System.Linq" para obtener dia de la 
...

                    {
                        ...
                        if (opcion_2 == "s" || opcion_2 == "S")
                        {
                            ...
                            if (dia == "lunes" || dia == "martes" || dia == "miércoles" || dia == "jueves" || dia == "viernes")
                            {
                                ...
                                {
                                Console.WriteLine("         Hoy Sábado se trabaja sólo 4hr.\n" +
                                    "");
                                    horas_laborables = 5;
                                    ...
                                    for (int i = 1; i < horas_laborables;)     //Bucle que pide ingreso de datos/nro de pedidos al usuario
                                    {
...

                                        {
                                            ...
                                            if (total == 4)
                                            {
                                                Console.WriteLine("                   Se cumplieron las 4hr. Se termino el turno.");
                                                break;
                                            }
                                            else
                                                i++;            // Si no se llena la estructura sigue el bucle
...

                                {
                                    ...
                                    do
                                    {
...

                                        {
                                            ArrayList listadoarray = new ArrayList(pedido_individual); //Encapsulamiento del array para mantener constancia del dato
                                            if (dia=="sábado")
                                            Console.WriteLine("                           El ultimo pedido es el '{0}'", listadoarray[3]);
                                            else
...

                                    {
                                        ...
                                        IEnumerator mayores = listadoarray.GetEnumerator(1, 3);
